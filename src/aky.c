...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Allreduce( sendbuf, recvbuf, count, datatype, op, comm );
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Alltoallv( sendbuf, sendcnts, sdispls, sendtype, recvbuf,
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Gather( sendbuf, sendcnt, sendtype, recvbuf, recvcount,
         recvtype, root, comm );
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Gatherv( sendbuf, sendcnt, sendtype, recvbuf, recvcnts,
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Reduce( sendbuf, recvbuf, count, datatype, op, root, comm );
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Scatter( sendbuf, sendcnt, sendtype, recvbuf, recvcnt,
          recvtype, root, comm );
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Scatterv( sendbuf, sendcnts, displs, sendtype, recvbuf,
...
int keyval;
{
  ...
  int returnVal = PMPI_Attr_delete( comm, keyval );
...
int * flag;
{
  ...
  int returnVal = PMPI_Attr_get( comm, keyval, attr_value, flag );
...
void * attr_value;
{
  ...
  int returnVal = PMPI_Attr_put( comm, keyval, attr_value );
...
MPI_Comm * comm_out;
{
  ...
  int returnVal = PMPI_Intercomm_create( local_comm, local_leader, peer_comm,
...
void * extra_state;
{
  ...
  int returnVal = PMPI_Keyval_create( copy_fn, delete_fn, keyval, extra_state );
...
int * keyval;
{
  ...
  int returnVal = PMPI_Keyval_free( keyval );
...
MPI_Errhandler * errhandler;
{
  ...
  int returnVal = PMPI_Errhandler_create( function, errhandler );
...
MPI_Errhandler * errhandler;
{
  ...
  int returnVal = PMPI_Errhandler_get( comm, errhandler );
...
MPI_Errhandler errhandler;
{
  ...
  int returnVal = PMPI_Errhandler_set( comm, errhandler );
...
MPI_Aint * address;
{
  ...
  int returnVal = PMPI_Address( location, address );
...
MPI_Request * request;
{
  ...
  int returnVal = PMPI_Send_init( buf, count, datatype, dest, tag, comm, request );
...
MPI_Request * request;
{
  ...
  int returnVal = PMPI_Ibsend( buf, count, datatype, dest, tag, comm, request );
...
MPI_Request * request;
{
  ...
  int returnVal = PMPI_Irsend( buf, count, datatype, dest, tag, comm, request );
...
MPI_Request * request;
{
  ...
  int returnVal = PMPI_Issend( buf, count, datatype, dest, tag, comm, request );
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Pack( inbuf, incount, type, outbuf, outcount, position,
       comm );
...
MPI_Status * status;
{
  ...
  int returnVal = PMPI_Sendrecv( sendbuf, sendcount, sendtype, dest, sendtag,
...
MPI_Status * status;
{
  ...
  int returnVal = PMPI_Sendrecv_replace( buf, count, datatype, dest, sendtag,
...
MPI_Status * status;
{
  ...
  int returnVal = PMPI_Testany( count, array_of_requests, index, flag, status );
...
MPI_Aint * extent;
{
  ...
  int returnVal = PMPI_Type_extent( datatype, extent );
...
MPI_Datatype * newtype;
{
  ...
  int returnVal = PMPI_Type_hindexed( count, blocklens, indices, old_type,
          newtype );
...
MPI_Datatype * newtype;
{
  ...
  int returnVal = PMPI_Type_hvector( count, blocklen, stride, old_type, newtype );
...
{
  rst_event (MPI_TYPE_LB_IN);
  int returnVal = PMPI_Type_lb( datatype, displacement );
  rst_event (MPI_TYPE_LB_OUT);
  return returnVal;
}
...
MPI_Datatype * newtype;
{
  ...
  int returnVal = PMPI_Type_struct( count, blocklens, indices, old_types,
        newtype );
...
MPI_Aint * displacement;
{
  rst_event (MPI_TYPE_UB_IN);
  int returnVal = PMPI_Type_ub( datatype, displacement );
  rst_event (MPI_TYPE_UB_OUT);
  return returnVal;
}
...
MPI_Datatype * newtype;
{
  ...
  int returnVal = PMPI_Type_vector( count, blocklen, stride, old_type, newtype );
...
MPI_Comm comm;
{
  ...
  int returnVal = PMPI_Unpack( inbuf, insize, position, outbuf, outcount, type,
         comm );
...
MPI_Comm * comm_graph;
{
  ...
  int returnVal = PMPI_Graph_create( comm_old, nnodes, index, edges, reorder,
         comm_graph );
...
int * neighbors;
{
  ...
  int returnVal = PMPI_Graph_neighbors( comm, rank, maxneighbors, neighbors );
