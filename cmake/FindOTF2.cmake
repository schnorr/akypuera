...
IF(OTF2_LIBRARY)
  ...
  SET (OTF2_LIBRARY_PATH CACHE PATH "" ${OTF2_LIBRARY_tmp})
ELSE(OTF2_LIBRARY)
...
IF(SCOREP_LIBRARY)
  ...
  SET (SCOREP_LIBRARY_PATH CACHE PATH "" ${SCOREP_LIBRARY_tmp})
ELSE(SCOREP_LIBRARY)
...
IF(OTF2_INCLUDE_tmp)
  SET (OTF2_INCLUDE_PATH CACHE PATH "" "${OTF2_INCLUDE_tmp}")
ELSE(OTF2_INCLUDE_tmp)
  SET (OTF2_INCLUDE_PATH CACHE PATH "" "OTF2_INCLUDE_PATH-NOTFOUND" )
