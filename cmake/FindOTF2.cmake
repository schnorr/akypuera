...
IF(OTF2_LIBRARY)
  ...
  SET (OTF2_LIBRARY_PATH ${OTF2_LIBRARY_tmp} CACHE PATH "The OTF2 library")
ELSE(OTF2_LIBRARY)
  SET (OTF2_LIBRARY_PATH "" CACHE PATH "OTF2_LIBRARY_PATH-NOTFOUND" )
...
IF(SCOREP_LIBRARY)
  MESSAGE ( STATUS "Found SCOREP library: ${SCOREP_LIBRARY}" )
  GET_FILENAME_COMPONENT(SCOREP_LIBRARY_tmp "${SCOREP_LIBRARY}" PATH)
  SET (SCOREP_LIBRARY_PATH ${SCOREP_LIBRARY_tmp} CACHE PATH "The SCOREP library")
ELSE(SCOREP_LIBRARY)
  SET (SCOREP_LIBRARY_PATH "" CACHE PATH "SCOREP_LIBRARY_PATH-NOTFOUND" )
  unset(LIBRARY_PATH CACHE)
ENDIF(SCOREP_LIBRARY)
...
IF(OTF2_INCLUDE_tmp)
  SET (OTF2_INCLUDE_PATH "${OTF2_INCLUDE_tmp}" CACHE PATH "The OTF2 include path")
ELSE(OTF2_INCLUDE_tmp)
  SET (OTF2_INCLUDE_PATH "" CACHE PATH "OTF2_INCLUDE_PATH" )
...
IF( OTF2_INCLUDE_PATH )
  IF( OTF2_LIBRARY_PATH )
    IF ( SCOREP_LIBRARY_PATH )
      SET( OTF2_FOUND TRUE )
    ENDIF ( SCOREP_LIBRARY_PATH )
  ENDIF ( OTF2_LIBRARY_PATH )
ENDIF( OTF2_INCLUDE_PATH )

IF( NOT OTF2_FOUND )
  MESSAGE(STATUS "OTF2/SCOREP installation was not found. Please provide OTF2_PATH:")
