...
FIND_LIBRARY(TAU_LIBRARY
  NAMES TAU
  PATHS /usr/lib /usr/local/lib ${TAU_PATH}/lib ${TAU_PATH}/x86_64/lib/)

IF(TAU_LIBRARY)
  MESSAGE ( STATUS "Found TAU: ${TAU_LIBRARY}" )
  GET_FILENAME_COMPONENT(TAU_LIBRARY_tmp "${TAU_LIBRARY}" PATH)
  SET (TAU_LIBRARY_PATH CACHE PATH "" ${TAU_LIBRARY_tmp})
ELSE(TAU_LIBRARY)
  SET (TAU_LIBRARY_PATH CACHE PATH "" "TAU_LIBRARY_PATH-NOTFOUND")
...
IF(TAU_INCLUDE_tmp)
  SET (TAU_INCLUDE_PATH CACHE PATH "TAU_INCLUDE_PATH" "${TAU_INCLUDE_tmp}")
ELSE(TAU_INCLUDE_tmp)
  SET (TAU_INCLUDE_PATH CACHE PATH "TAU_INCLUDE_PATH" "TAU_INCLUDE_PATH-NOTFOUND")
